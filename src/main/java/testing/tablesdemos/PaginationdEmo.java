...
public class PaginationdEmo {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for(int p=2;p<=10;p++)   //for(int p=1;p<=total_pages;p++)
		{
			if(total_pages>1)
			{
				Thread.sleep(500);
				WebElement active_Page=driver.findElement(By.xpath("//ul[@class='pagination']//li[@class='page-item']//a[normalize-space()='"+p+"']"));	
